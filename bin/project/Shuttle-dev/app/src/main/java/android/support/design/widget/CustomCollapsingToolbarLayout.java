...
protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    shiftNonSystemWindowsViews();
    updateCollapsedBounds();
    updateChildViewOffsetHelpers();
    setMinimumHeightForToolbar();
    updateScrimVisibility();
}

private void shiftNonSystemWindowsViews() {
    if (mLastInsets != null) {
...
private void updateCollapsedBounds() {
    if (mCollapsingTitleEnabled && mDummyView != null) {
        ...
        if (mDrawCollapsingTitle) {
            // Update the collapsed and expanded bounds
            // ...
        }
    }
}
...
private void setMinimumHeightForToolbar() {
    if (mToolbar != null) {
            ...
            for (int i = 0, z = getChildCount(); i < z; i++) {
                ...
                switch (lp.mCollapseMode) {
                    ...
                    case LayoutParams.COLLAPSE_MODE_PARALLAX:
                        ...
                        break;
                    default:
                        // Handle unexpected collapse modes here
                        break;
                }
